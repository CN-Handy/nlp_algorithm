...
# codecs python 自带的一个数据读取模块，比直接用open用途更多
...
# 小明小王是我的好朋友，也是李华小张的好朋友。
# B-PER I-PER B-PER I-PER O O O O O O O O O B-PER I-PER B-PER I-PER O O O O

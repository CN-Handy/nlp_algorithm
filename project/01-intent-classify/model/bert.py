...
tokenizer = AutoTokenizer.from_pretrained(BERT_MODEL_PERTRAINED_PATH, local_files_only=True)
model = BertForSequenceClassification.from_pretrained(BERT_MODEL_PERTRAINED_PATH, num_labels=12, local_files_only=True)
